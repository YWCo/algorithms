...
st.set_page_config(page_title="Long Call Algorithm",
...
st.markdown("<h1 style='text-align: center; color: black;'>Long Call Algorithm</h1>", unsafe_allow_html=True)
@st.cache_data
...
if purpose_select==purpose[0]:
    build_pos=st.radio("Build long call position?",options=["Yes","no"],index=0) 
    if build_pos=="Yes":
        ...
        st.sidebar.subheader("Long call position builder")
