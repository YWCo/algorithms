...
if purpose_select==purpose[0]:
    ...
    if build_pos=="Yes":
        ...
        premium_investment=st.number_input("Enter amount of capital to risk in premium:",min_value=0,step=10,value=int(last_price*100))
        ...
        if max_contracts_buy==0:
            st.write("Minimum premium amount required is",round(last_price*100,2),"USD.")
        ...
        if  nr_contracts_buy==0:
            ...
            st.write("The profit amount would be: ",round((last_price*(perc_profit))*100*nr_contracts_buy,2),"USD.")
            st.write("The stop loss price is: ",round(last_price*(1-perc_risk),2))
            st.write("The loss amount would be: ",round((last_price*(perc_risk))*100*nr_contracts_buy,2),"USD.")
    ...
    if  nr_contracts_buy==0:
        ...
        st.write("The profit amount would be: ",round((entry_price*(perc_profit))*100*nr_contracts_buy,2),"USD.")
        st.write("The stop loss price is: ",round(entry_price*(1-perc_risk),2))
        st.write("The loss amount would be: ",round((entry_price*(perc_risk))*100*nr_contracts_buy,2),"USD.")
        st.write("The running P&L is:",round((live_price-entry_price)*100*nr_contracts_buy,2),"USD.")
